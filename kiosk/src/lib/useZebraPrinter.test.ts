...
/** Ported from portal/src/lib/useZebraPrinter.test.tsx — same fake USB
 *  device, same expectations; only the zebraUsb import moves to
 *  @portal (the transport is shared, the hook is the kiosk's own). */
import { act, renderHook } from '@testing-library/react';
import { describe, expect, it, vi } from 'vitest';

import type { UsbDeviceLike } from '@portal/labels/zebraUsb';
