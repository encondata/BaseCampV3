...
from serversherpa.services.initiatives import INITIATIVE_PALETTE  # noqa: F401  (tests import it from here)
...
async def next_initiative_color(
    ...
    return InitiativeNextColorOut(color=await next_color(db))
