...
const CRUMBS: Record<string, string[]> = {
  ...
  '/labels/printers': ['Labels', 'Printers'],
  '/reports': ['Reports', 'Reports'],
  '/hardware/handheld-readers': ['Scanning Hardware', 'Handheld Readers'],
...
const PAGES = [
  ...
  { label: 'Print Labels', to: '/labels/print' },
  { label: 'Generate Labels', to: '/labels/generate' },
  { label: 'Templates', to: '/labels/templates' },
  { label: 'Printers', to: '/labels/printers' },
  { label: 'Reports', to: '/reports' },
  { label: 'Handheld Readers', to: '/hardware/handheld-readers' },
